    ...
    <ParallaxLayer offset={0.4} speed={1.8} className="flex justify-around flex-row-reverse flex-wrap items-center aboutme">
      <ul>
        <li className="text-2xl font-bold text-base-600">
          <FontAwesomeIcon icon={faUser} />  <span className="text-base-500">Andréas Arnolfo</span>
        </li>
        <li className="text-2xl font-bold text-base-600">
        ...
        <li className="text-2xl font-bold text-base-600">
          <FontAwesomeIcon icon={faHeart} /> <span className="text-base-500">Célibataire</span>
        </li>
      </ul>
      ...
      <ul >
        ...
        <li className="text-2xl font-bold text-base-600">
          <FontAwesomeIcon icon={faGamepad} /> <span className="text-base-500">Jeux vidéos</span>
        </li>
        <li className="text-2xl font-bold text-base-600">
          <FontAwesomeIcon icon={faGamepad} /> <span className="text-base-500">Jeux de société</span>
        </li>
        <li className="text-2xl font-bold text-base-600">
        ...
        <li className="text-2xl font-bold text-base-600">
          <FontAwesomeIcon icon={faFilm} /> <span className="text-base-500">Films/Séries</span>
        </li>
